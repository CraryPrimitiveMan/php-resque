...
class WorkerTest extends TestCase
{
    ...
    public function testWorkerCanWorkOverMultipleQueues()
    {
        ...
        $worker->registerWorker();
        Resque::enqueue('queue1', '\resque\test\job\Job1');
        Resque::enqueue('queue2', '\resque\test\job\Job2');
    ...
    public function testWorkerWorksQueuesInSpecifiedOrder()
    {
        ...
        Resque::enqueue('low', '\resque\test\job\Job1');
        Resque::enqueue('high', '\resque\test\job\Job2');
        Resque::enqueue('medium', '\resque\test\job\Job3');
